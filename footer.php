...
<footer class=" py-10 lg:py-10 flex flex-col items-center gap-5 border-t border-gray-300">

    <!-- لوگو -->
    <div class="w-30 md:w-40 justify-center">
    ...
    <div class="flex flex-wrap justify-center gap-4">
        <?php if ($facebook): ?>
            <a href="<?php echo esc_url($facebook); ?>" target="_blank"
                class="w-10 h-10 flex items-center justify-center rounded-full border-2 border-gray-300">
                <svg width="7" height="16" viewBox="0 0 7 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M1.55073 15.5V7.99941H0V5.41457H1.55073V3.86264C1.55073 1.75393 2.42638 0.5 4.91418 0.5H6.98534V3.08514H5.69072C4.72228 3.08514 4.65821 3.44637 4.65821 4.12054L4.65469 5.41428H7L6.72556 7.99912H4.65469V15.5H1.55073Z"
                        fill="#0A142F" />
                </svg>
            </a>
        <?php endif; ?>
        ...
        <?php if ($linkedin): ?>
            <a href="<?php echo esc_url($linkedin); ?>" target="_blank"
                ...
                <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M1.49108 3.5H1.47404C0.578773 3.5 0 2.83303 0 1.99948C0 1.14831 0.5964 0.5 1.50865 0.5C2.42091 0.5 2.98269 1.14831 3 1.99948C3 2.83303 2.42091 3.5 1.49108 3.5Z"
                        fill="#0A142F" />
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        d="M13.9999 14.4998H11.0519V9.79535C11.0519 8.61371 10.6253 7.80738 9.55814 7.80738C8.74368 7.80738 8.25855 8.35096 8.04549 8.87598C7.96754 9.06414 7.94841 9.3263 7.94841 9.58911V14.5H5C5 14.5 5.03886 6.53183 5 5.70672H7.94841V6.95221C8.33968 6.35348 9.04046 5.5 10.6057 5.5C12.5456 5.5 14 6.75705 14 9.45797L13.9999 14.4998Z"
                        fill="#0A142F" />
                </svg>
    ...
    <div class="text-center text-gray-500 text-sm">
        کلیه حقوق این سایت برای لوپ مارکت محفوظ می‌باشد.
    </div>
